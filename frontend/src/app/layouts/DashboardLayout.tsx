...
export function DashboardLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 text-slate-900 font-sans">
      ...
      >
        <div
          className="h-16 flex items-center px-6 border-b border-white/10 shrink-0 cursor-pointer"
        ...
        <div className="p-3 border-t border-white/10">
          <button
            ...
            className="flex items-center w-full px-3 py-2.5 text-slate-300 hover:bg-white/10 hover:text-white rounded-lg transition-colors"
          >
        ...
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-8 sticky top-0 z-40">
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-3 pl-6 border-l border-gray-200">
              ...
              <div className="size-10 bg-brand-navy rounded-full border-2 border-gray-100 flex items-center justify-center text-white font-bold text-sm">
                {initials}
              </div>
            </div>
          </div>
